...
title: works — RuneBlaze
---

<div class="tagline">
Games, open source, music.
</div>
...
<div class="row">
  <div class="column">
    <video autoplay loop muted playsinline src="https://ai.google.dev/static/videos/winners/penapple.mp4"></video>
...
- [Coarse](https://github.com/RuneBlaze/coarse), a functional-programming (lens) library in Clojure.
- [Siki.lua](https://github.com/BakaBBQ/siki.lua), a game-data GUI editor for fighting games, in Lua + Löve2d.
- [purescript-express](https://github.com/purescript-express/purescript-express), a web framework for PureScript (contributor).

## Music

As part of [Mad Hatter Tea](https://en.touhouwiki.net/wiki/%E7%96%AF%E5%B8%BD%E5%AD%90%E8%8C%B6%E4%BC%9A).

- **Qingdao THOnly 2017**, MhT X 青岛THO纪念专辑. [Listen here](https://music.163.com/#/album?id=73915857).
- **泡沫、温泉、おしまい**, a piano piece. [Listen here](https://music.163.com/#/album?id=73915857).
- **Necrofantasia (Take 1)**, an attempt at something jazzy. [Listen here](https://music.163.com/#/song?id=1822832248).
